...
<div class="halloween-header">
  <h1>🎃 Safety & Risk's Sp00ky Password Calculator 👻</h1>
</div>
...
**Did you know?**
A hacker's script can be like a horde of the undead trying over 1 BILLION ($10^9$) passwords per SECOND! But with the right password—one that could baffle a whole cemetery of the dead—they'll never feast on your digital data!

## The Exponential Math Protecting you from the Undead

Your password strength doesn't just grow; it rises from the grave exponentially. Every character you add is like another steel bolt on a vault door, drastically increasing the time required for a zombie hacking script to crack your password.
...
Think of your password's strength as the defense of a haunted crypt against the endless assault of the undead:

**1. Grave-Weak (Lowercase Only)** 

A thin wooden door. Minimal protection. ($26$ characters)

**2. Rigor Mortis-Stronger (Lower and Uppercase letters)** 

Reinforced planks. Doubles the available character pool. ($52$ characters)

**3. Standard Practice (Lower and Uppercase letters with numbers)**

A stone slab barricade. The essential baseline for preventing attacks. ($62$ characters)

**4. Maximum Defense (Lower and Uppercase letters, numbers, and special characters)** 

A thick, steel vault door. The absolute highest level of protection, enough to stop the entire un-resting horde! ($95$ characters)

## Try it Out!
Use the slider below to see the immense jump in protection provided by the four character set levels:

Aim to create passwords that will take millions, or even billions of years to crack even if hackers are trying billions of possibilities per second.
...
## Would your password protect you from a horde of zombies?
